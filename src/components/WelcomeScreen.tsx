...
import logoImage from 'figma:asset/5e87d41c365ac21a3712e960fa78cefd710d4233.png';
...
export default function WelcomeScreen({ onStartChat, navigate, user }: WelcomeScreenProps) {
  ...
  const quickActions = [
    { icon: Sparkles, label: '2학년 컴퓨터공학과 시간표 생성' },
    { icon: Upload, label: '이전 시간표 업로드' },
    { icon: FileText, label: '3학년 경영학과 추천' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#020103] relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 p-6 flex items-center justify-end gap-3">
        {user && (
          <Button
            variant="ghost"
            size="sm"
